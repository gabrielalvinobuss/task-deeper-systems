import {
  script as script7
} from "./chunk-AOC5GWBJ.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService
} from "./chunk-LKQNSOF2.js";
import {
  FocusTrap,
  script as script5,
  script2 as script8
} from "./chunk-YAAFHIEB.js";
import {
  Ripple,
  script as script3,
  script2 as script9,
  script3 as script10
} from "./chunk-IKGTCIFR.js";
import "./chunk-NJLFWAFJ.js";
import {
  script as script4,
  script2 as script11
} from "./chunk-GXPQN2QG.js";
import {
  script as script6
} from "./chunk-7NA37ROH.js";
import {
  script as script2
} from "./chunk-E43Y75BG.js";
import {
  script
} from "./chunk-3GGXRSGQ.js";
import {
  BaseStyle,
  EventBus,
  ZIndex,
      ...
      if (isRangeChanged) {
        ...
        if (this.lazy && this.isPageChanged(first4)) {
          ...
          var lazyLoadState = {
            ...
            last: Math.min(this.step ? (this.getPageByFirst(first4) + 1) * this.step : last3, ((_this$items3 = this.items) === null || _this$items3 === void 0 ? void 0 : _this$items3.length) - 1 || 0)
          };
...
var script21 = {
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty4({}, typeof _this18.optionGroupChildren === "string" ? _this18.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
  ...
  components: {
    InputText: script7,
    VirtualScroller: script20,
    Portal: script8,
    InputIcon: script19,
    IconField: script18,
    TimesIcon: script5,
    ChevronDownIcon: script16,
    SpinnerIcon: script3,
    SearchIcon: script17,
    CheckIcon: script4,
    BlankIcon: script15
...
var script24 = {
  ...
  methods: {
    ...
    onPaste: function onPaste(event2) {
      event2.preventDefault();
      var data16 = (event2.clipboardData || window["clipboardData"]).getData("Text");
      if (data16) {
  ...
  computed: {
    ...
    dataP: function dataP() {
      return cn(_defineProperty5(_defineProperty5({
  ...
  components: {
    InputText: script7,
    AngleUpIcon: script23,
    AngleDownIcon: script22
  }
};
var _hoisted_13 = ["data-p"];
var _hoisted_22 = ["data-p"];
var _hoisted_32 = ["disabled", "data-p"];
var _hoisted_42 = ["disabled", "data-p"];
var _hoisted_52 = ["disabled", "data-p"];
...
function render13(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
  ...
  })], 16, _hoisted_22)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "incrementbutton", {
    listeners: $options.upButtonListeners
  }, function() {
    ...
    })], 16, _hoisted_52)) : createCommentVNode("", true)];
  }), renderSlot(_ctx.$slots, "decrementbutton", {
    listeners: $options.downButtonListeners
  }, function() {
    return [_ctx.showButtons && _ctx.buttonLayout !== "stacked" ? (openBlock(), createElementBlock("button", mergeProps({
...
var _hoisted_14 = ["aria-label", "aria-current", "onClick", "data-p-active"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    }), [createTextVNode(toDisplayString(pageLink), 1)], 16, _hoisted_14)), [[_directive_ripple]]);
  }), 128))], 16);
}
...
var script28 = {
  ...
  methods: {
    ...
    hasBreakpoints: function hasBreakpoints() {
      return _typeof6(this.template) === "object";
    },
...
function render21(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "data-p": $options.dataP
  }), null, 16, _hoisted_43)], 16, _hoisted_33)], 16, _hoisted_15);
}
...
function _regeneratorRuntime() {
  ...
  function AsyncIterator(t2, e2) {
    function invoke(r3, o2, i2, a2) {
      ...
      if ("throw" !== c2.type) {
        ...
        return h2 && "object" == _typeof$c(h2) && n.call(h2, "__await") ? e2.resolve(h2.__await).then(function(t3) {
  ...
  function values(e2) {
    ...
    throw new TypeError(_typeof$c(e2) + " is not iterable");
  }
...
var script$92 = {
  ...
  methods: {
    ...
    findIndexInSelection: function findIndexInSelection(data16) {
      return this.findIndex(data16, this.selection);
    },
    findIndex: function findIndex(data16, collection) {
      var index = -1;
      if (collection && collection.length) {
        for (var i = 0; i < collection.length; i++) {
          if (this.equals(data16, collection[i])) {
            index = i;
            break;
          }
        }
...
function render$72(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getColumnPT("columnFooter")), toDisplayString($options.columnProp("footer")), 17)) : createCommentVNode("", true)], 16, _hoisted_1$3);
}
...
var script$52 = {
  ...
  components: {
    ...
    Button: script10,
    Portal: script8,
    FilterSlashIcon: script35,
    FilterFillIcon: script34,
    FilterIcon: script33,
    TrashIcon: script37,
    PlusIcon: script36
  },
...
var _hoisted_1$2 = ["id", "aria-modal"];
var _hoisted_24 = ["onClick", "onKeydown", "tabindex"];
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            return openBlock(), createElementBlock("li", mergeProps({
              ...
              tabindex: i === 0 ? "0" : null,
              ref_for: true
            }, $options.getColumnPT("filterConstraint", $options.ptmFilterConstraintOptions(matchMode))), toDisplayString(matchMode.label), 17, _hoisted_24);
            ...
            filterModel: $props.filters[$props.field],
            filterCallback: $options.filterCallback
          }, null, 8, ["field", "filterModel", "filterCallback"]))], 16, _hoisted_1$2)), [[_directive_focustrap]]) : createCommentVNode("", true)];
        }),
        _: 1
      }, 16, ["onEnter", "onAfterEnter", "onLeave", "onAfterLeave"])];
    }),
...
var _hoisted_1$1 = ["data-p-frozen-column"];
...
var script$22 = {
  ...
  components: {
    ...
    DTHeaderCheckbox: script$42,
    DTColumnFilter: script$52,
    SortAltIcon: script38,
    SortAmountUpAltIcon: script40,
    SortAmountDownIcon: script39
  }
};
...
var _hoisted_16 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-sorted", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
...
var script41 = {
  ...
  methods: {
    ...
    sortSingle: function sortSingle(value) {
      ...
      var data16 = _toConsumableArray4(value);
      var resolvedFieldData = /* @__PURE__ */ new Map();
      var _iterator = _createForOfIteratorHelper(data16), _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      ...
      data16.sort(function(data1, data22) {
    ...
    filter: function filter2(data16) {
      var _this5 = this;
      if (!data16) {
        return;
      }
      ...
      for (var i = 0; i < data16.length; i++) {
            ...
            if (filterMeta.operator) {
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                  ...
                  localMatch = this.executeLocalFilter(filterField, data16[i], filterConstraint2);
              ...
              localMatch = this.executeLocalFilter(filterField, data16[i], filterMeta);
            }
            if (!localMatch) {
              break;
            }
        ...
        if (localMatch && activeFilters["global"] && !globalMatch && globalFilterFieldsArray) {
          for (var j = 0; j < globalFilterFieldsArray.length; j++) {
            ...
            globalMatch = FilterService.filters[activeFilters["global"].matchMode || FilterMatchMode.CONTAINS](resolveFieldData(data16[i], globalFilterField), activeFilters["global"].value, this.filterLocale);
            if (globalMatch) {
              break;
            }
          }
        ...
        switch (event2.code) {
          ...
          default:
            if (event2.code === "KeyA" && metaKey && this.isMultipleSelectionMode()) {
              var data16 = this.dataToRender(slotProps.rows);
              this.$emit("update:selection", data16);
            }
    ...
    onArrowDownKey: function onArrowDownKey2(event2, row2, rowIndex2, slotProps) {
      ...
      if (event2.shiftKey) {
        var data16 = this.dataToRender(slotProps.rows);
        var nextRowIndex = rowIndex2 + 1 >= data16.length ? data16.length - 1 : rowIndex2 + 1;
        this.onRowClick({
          originalEvent: event2,
          data: data16[nextRowIndex],
          index: nextRowIndex
        });
      }
      event2.preventDefault();
    ...
    onHomeKey: function onHomeKey2(event2, row2, rowIndex2, slotProps) {
      ...
      if (event2.ctrlKey && event2.shiftKey) {
        var data16 = this.dataToRender(slotProps.rows);
        this.$emit("update:selection", data16.slice(0, rowIndex2 + 1));
      }
      event2.preventDefault();
    },
    onEndKey: function onEndKey2(event2, row2, rowIndex2, slotProps) {
      ...
      if (event2.ctrlKey && event2.shiftKey) {
        var data16 = this.dataToRender(slotProps.rows);
        this.$emit("update:selection", data16.slice(rowIndex2, data16.length));
      }
      event2.preventDefault();
    },
    ...
    onSpaceKey: function onSpaceKey2(event2, rowData, rowIndex2, slotProps) {
      ...
      if (event2.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = findIndexInList(this.selection[0], data16);
          lastSelectedRowIndex = findIndexInList(this.selection[this.selection.length - 1], data16);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = findIndexInList(this.selection, data16);
        }
        var _selection = index !== rowIndex2 ? data16.slice(Math.min(index, rowIndex2), Math.max(index, rowIndex2) + 1) : rowData;
        this.$emit("update:selection", _selection);
      }
    },
      ...
      if (Array.isArray(selection)) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
            var data16 = _step3.value;
            this.d_selectionKeys[String(resolveFieldData(data16, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (editingRows && editingRows.length) {
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            var data16 = _step4.value;
            this.d_editingRowKeys[String(resolveFieldData(data16, this.dataKey))] = 1;
          }
        } catch (err) {
          _iterator4.e(err);
        } finally {
    ...
    exportCSV: function exportCSV$1(options2, data16) {
      var _this6 = this;
      var csv = "\uFEFF";
      if (!data16) {
        data16 = this.processedData;
        if (options2 && options2.selectionOnly) data16 = this.selection || [];
        else if (this.frozenValue) data16 = data16 ? [].concat(_toConsumableArray4(this.frozenValue), _toConsumableArray4(data16)) : this.frozenValue;
      }
      ...
      if (data16) {
        data16.forEach(function(record) {
          csv += "\n";
    ...
    onRowDrop: function onRowDrop2(event2) {
      if (this.droppedRowIndex != null) {
        ...
        var processedData2 = _toConsumableArray4(this.processedData);
    ...
    toggleRowGroup: function toggleRowGroup(e) {
      var event2 = e.originalEvent;
      var data16 = e.data;
      var groupFieldValue = resolveFieldData(data16, this.groupRowsBy);
      var _expandedRowGroups = this.expandedRowGroups ? _toConsumableArray4(this.expandedRowGroups) : [];
      if (this.isRowGroupExpanded(data16)) {
    ...
    onEditingMetaChange: function onEditingMetaChange2(event2) {
      var data16 = event2.data, field2 = event2.field, index = event2.index, editing2 = event2.editing;
      var editingMeta = _objectSpread$1({}, this.d_editingMeta);
      var meta = editingMeta[index];
      if (editing2) {
        !meta && (meta = editingMeta[index] = {
          data: _objectSpread$1({}, data16),
          fields: []
        });
    ...
    dataToRender: function dataToRender(data16) {
      var _data = data16 || this.processedData;
  ...
  computed: {
    columns: function columns() {
      ...
      if (this.reorderableColumns && this.d_columnOrder) {
        ...
        return [].concat(orderedColumns, _toConsumableArray4(cols.filter(function(item) {
    ...
    processedData: function processedData() {
      ...
      if (!this.lazy && !((_this$virtualScroller = this.virtualScrollerOptions) !== null && _this$virtualScroller !== void 0 && _this$virtualScroller.lazy)) {
        if (data16 && data16.length) {
          if (this.hasFilters) {
            data16 = this.filter(data16);
          }
          if (this.sorted) {
            if (this.sortMode === "single") data16 = this.sortSingle(data16);
            else if (this.sortMode === "multiple") data16 = this.sortMultiple(data16);
          }
        }
      }
      return data16;
    ...
    totalRecordsLength: function totalRecordsLength() {
      if (this.lazy) {
        ...
        var data16 = this.processedData;
        return data16 ? data16.length : 0;
      }
    },
