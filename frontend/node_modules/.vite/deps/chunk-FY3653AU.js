import {
  PrimeVueService
} from "./chunk-WMSQBHQH.js";
import {
  script as script2
} from "./chunk-WIU6VRNO.js";
import {
  Base,
  script
} from "./chunk-4CKKJYVI.js";
import {
  BaseStyle,
  addClass,
  cn,
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      ...
      if (!ink) {
        ink = createElement("span", _defineProperty3(_defineProperty3({
          role: "presentation",
          "aria-hidden": true,
          "data-p-ink": true,
...
var script5 = {
  ...
  computed: {
    ...
    dataP: function dataP2() {
      return cn(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return cn(_defineProperty5(_defineProperty5({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return cn(_defineProperty5(_defineProperty5({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script3,
...
//# sourceMappingURL=chunk-FY3653AU.js.map
